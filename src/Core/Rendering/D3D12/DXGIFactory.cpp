...
namespace Kraid
{
    ...
    namespace D3D12
    {
        ...
        {
#ifndef NDEBUG
            D3DCALL(CreateDXGIFactory2(DXGI_CREATE_FACTORY_DEBUG , IID_PPV_ARGS(&this->factory)), "DXGI Factory created with debug enabled");
#else
            D3DCALL(CreateDXGIFactory2(NULL, IID_PPV_ARGS(&this->factory)), "DXGI Factory created");
#endif
        }
